# Rodolfo L. Abando, Jr.
### Eager to connect and contribute expertise in Cybersecurity, AI, and Operational Technology Integrity.

---

## 👨‍💻 About Me
Highly meticulous and adaptable professional, grounded in the rigorous principles of safe and efficient maritime operations, holding a Bachelor of Science in Marine Transportation. I am strategically transitioning my focus into Cybersecurity and Artificial Intelligence (AI) by actively building expertise through specialized courses, hands-on technical projects, and foundational concepts. 

My professional identity is defined by a rigorous approach to information organization, strong discipline, exceptional problem-solving abilities, and high-level teamwork skills. I leverage these strengths, along with practical skills in packet analysis, network defense, and relational databases, to proactively address challenges and contribute to organizational security.

*   **Current Focus:** Building a foundational portfolio through specialized cybersecurity and AI courses.
*   **Core Objective:** Transferring maritime standards of operational discipline, strict regulatory compliance, and high reliability to modern ICT environments.

---

## 🛠️ Technical Toolkit
*   **Security & Monitoring:** Wireshark, Suricata (IDS), Wazuh (SIEM), tcpdump, VirusTotal
*   **Databases & Analytics:** SQL (PostgreSQL/MySQL environments), Relational Data Filtering
*   **Programming & Automation:** Python (Algorithm development, programmatic file operations)
*   **Operating Systems:** Linux (Command Line & Utilities)
*   **Productivity & AI:** Google Workspace integrated with Gemini (Technical drafting & data organization)
...
## 📬 Contact & Connect
*   **LinkedIn:** [Connect with me on LinkedIn](https://www.linkedin.com/in/rodolfo-a-a85945349/)*
